...
export const CreditTrans=()=>{
    ...
    const handleCredit=()=>{
        ...
        const currTrans={cardtype,amnt,transtype:"C"}
        ...
        <React.Fragment>
            <Card sx={{height:250,border:"1px solid black"}}>
                ...
                <Grid container spacing={2}>
                    <Grid item xs={12}><h3>Credit Transactions</h3></Grid>
                <Grid item xs={5}>
                ...
                <Grid item xs={2}>
                    <Button variant="contained" fullWidth color="success" onClick={handleCredit} sx={{height:55}}>Credit</Button>
                </Grid>
            </Grid>
