...
export const DataListItem=({item,doRefresh})=>{
    ...
    const handleDelete=async (_id)=>{
        const payload={_id}
        await axios.post("http://localhost:3030/earningdelete",payload)     //first it will delete and await and pass to next line
        doRefresh()
    }
...
//since item is deleting but parent is not updating before refreshing page, prop uplifting is to be done